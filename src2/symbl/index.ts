...
export default class Symbl {
    ...
    // async createConnection(options: StreamingAPIConnectionConfig, audioStream?: AudioStream) : Promise<void> {
    ...
    //     this.validateStreamingAPIConnectionConfig(options);

    //     if (!options.id) {
    //         options.id = uuid();
    //         }
    //         try {
    //         const connection = new Connection(options.id, options);
    //         connection.connect();
    //         } catch (e) {
    //         throw e;
    //         }
    ...
    // createAndStartNewConnection(options: StreamingAPIConnectionConfig, audioStream?: AudioStream) : Promise<Connection> {
    ...
    // subscribeToConnection(sessionId: string) : Promise<Connection> {
    ...
    // static wait(time: number, unit = TimeUnit.MS) : Promise {
