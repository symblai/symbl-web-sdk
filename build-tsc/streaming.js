"use strict";
var _a = require('./utils.js'), symblFetch = _a.symblFetch, logger = _a.logger, defaultConfig = _a.defaultConfig, uuid = _a.uuid;
...
var RealtimeApi = (function () {
    ...
    RealtimeApi.prototype.sendStart = function (resolve, reject) {
        var _a = this.options, insightTypes = _a.insightTypes, config = _a.config, speaker = _a.speaker;
        if (config) {
...
var Streaming = (function () {
    ...
    Streaming.prototype.start = function () {
        ...
        var startRequest = function (resolve, reject) {
